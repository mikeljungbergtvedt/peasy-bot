...
class AutodiscoverRequest {
    ...
    static IsRedirectionResponse(httpWebResponse) {
        return (httpWebResponse.status == 302 /* HttpStatusCode.Redirect */) ||
            (httpWebResponse.status == 301 /* HttpStatusCode.Moved */) ||
            (httpWebResponse.status == 307 /* HttpStatusCode.RedirectKeepVerb */) ||
            (httpWebResponse.status == 303 /* HttpStatusCode.RedirectMethod */);
    }
    /**
