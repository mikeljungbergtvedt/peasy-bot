...
exports.SafeXmlFactory = void 0;
class SafeXmlFactory {
    CreateSafeXmlTextReader(stream /*System.IO.Stream*/) { throw new Error("SafeXmlFactory.ts - CreateSafeXmlTextReader : Not implemented."); }
    ...
    CreateXPathDocument(uri, space /*System.Xml.XmlSpace*/) { throw new Error("SafeXmlFactory.ts - CreateXPathDocument : Not implemented."); }
}
