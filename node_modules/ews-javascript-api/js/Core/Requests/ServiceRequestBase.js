...
exports.ServiceRequestBase = void 0;
...
const EwsServiceXmlWriter_1 = require("../EwsServiceXmlWriter");
const EwsUtilities_1 = require("../EwsUtilities");
const ExchangeServerInfo_1 = require("../ExchangeServerInfo");
...
class ServiceRequestBase {
     ...
     */
    GetXmlElementName() { throw new Error("abstract method, must override"); }
    /**
     * @internal Gets the minimum server version required to process this request.
     *
     * @return  {ExchangeVersion}      Exchange server version.
     */
    GetMinimumRequiredServerVersion() { throw new Error("abstract method, must override"); }
    /**
     * @internal Gets the name of the response XML element.
     *
     * @return  {string}      XML element name,
     */
    GetResponseXmlElementName() { throw new Error("abstract method, must override"); }
    /**
     ...
     */
    WriteElementsToXml(writer) { throw new Error("abstract method, must override"); }
    //#endregion
    /**
     ...
     */
    AddHeaders(webHeaderCollection /*WebHeaderCollection*/) {
    ...
    BuildResponseObjectFromJson(jsObject) {
    ...
    GetEwsHttpWebResponse(request /*IEwsHttpWebRequest*/) { return this.service.XHRApi.xhr(request); }
    /**
    ...
    ProcessWebException(webException) {
        ...
        if (webException) {
            ...
            if (webException.status == 500 /* HttpStatusCode.InternalServerError */) {
                ...
                const msDiagMessage = ((_a = webException.getResponseHeader) === null || _a === void 0 ? void 0 : _a.call(webException, 'x-ms-diagnostics')) || '';
                soapFaultDetails = new SoapFaultDetails_1.SoapFaultDetails(webException && webException.message ? webException.message : msDiagMessage);
                soapFaultDetails.HttpStatusCode = webException.status;
     ...
     */
    ReadResponseXmlJsObject(jsObject) {
        if (jsObject[XmlElementNames_1.XmlElementNames.SOAPHeaderElementName]) {
            this.ReadSoapHeader(jsObject[XmlElementNames_1.XmlElementNames.SOAPHeaderElementName]);
        }
        ...
        var serviceResponse;
        let jsBody = jsObject[XmlElementNames_1.XmlElementNames.SOAPBodyElementName];
     ...
     */
    ReadSoapFault(jsSoapFault) {
        let soapFaultDetails = null;
        ...
        if (jsSoapFault[XmlElementNames_1.XmlElementNames.SOAPBodyElementName]) {
            let jsSoapBody = jsSoapFault[XmlElementNames_1.XmlElementNames.SOAPBodyElementName];
     ...
     */
    ValidateAndEmitRequest(request) {
        this.Validate();
