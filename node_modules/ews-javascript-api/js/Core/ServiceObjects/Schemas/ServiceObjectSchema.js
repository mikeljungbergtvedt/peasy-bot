...
exports.ServiceObjectSchema = void 0;
...
class ServiceObjectSchema {
     ...
     */
    get FirstClassProperties() { return this.firstClassProperties; } //System.Collections.Generic.List<PropertyDefinition>;
    /**
     * @internal Gets the list of first class summary properties for this service object type.
     */
    get FirstClassSummaryProperties() { return this.firstClassSummaryProperties; } //System.Collections.Generic.List<PropertyDefinition>;
    /**
     * @internal Gets the list of indexed properties for this service object type.
     */
    get IndexedProperties() { return this.indexedProperties; } //System.Collections.Generic.List<IndexedPropertyDefinition>;
     ...
     */
    static FindPropertyDefinition(uri) {
    ...
    constructor() {
        ...
        this.properties = new AltDictionary_1.Dictionary((key) => key); // System.Collections.Generic.Dictionary<TKey, TValue>;
     ...
     */
    RegisterIndexedProperty(indexedProperty) { this.indexedProperties.push(indexedProperty); }
    /**
     ...
     */
    RegisterInternalProperty(registeringSchemaClass, property) { this.RegisterProperty(registeringSchemaClass, property, true); }
    /**
     ...
     */
    RegisterProperties() { }
    RegisterProperty(registeringSchemaClass, property, isInternal = false) {
     ...
     */
    TryGetPropertyDefinition(xmlElementName, propertyDefinition) {
